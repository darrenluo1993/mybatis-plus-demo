...
(
    ...
    `name`          varchar(30) collate utf8mb4_0900_bin not null COMMENT '姓名',
    `age`           tinyint(3)                           not null COMMENT '年龄',
    `gender`        tinyint(1)                           not null COMMENT '性别 1:男 0:女',
    `email`         varchar(50)                          not null COMMENT '邮箱',
    `user_status`   tinyint(1) DEFAULT 1                 not null COMMENT '用户状态 1:正常 2:禁用 3:删除',
    `password_type` tinyint(1) DEFAULT 3                 not null COMMENT '密码类型 1:交易密码 2:查询密码 3:登录密码',
    `password`      varchar(300)                         null COMMENT '密码',
